...
public class EelPortion implements IngredientPortion {
  private Ingredient_Impl i = new Eel();
  ...
  public double getCost() {return i.getPricePerOunce() * ounces;}
  public IngredientPortion combine(IngredientPortion other) {
    if (!this.i.equals(other.getIngredient())) {throw new IllegalArgumentException("Ingredients are not the same");}
    else {
      IngredientPortion combined = new EelPortion(ounces + other.getAmount());
      return combined;
    }
  }
}
